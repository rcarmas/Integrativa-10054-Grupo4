Vue.component('portfolio-item', {
    props: ['repositories', 'name', 'description', 'image'],
    template: `
      <div class="col-lg-6">
        <a class="portfolio-item" :href="repositories">
          <div class="caption">
            <div class="caption-content">
              <div class="h2" style="padding-left: 215px;">{{ name }}
              <p></p>
              <p class="mb-0" style="font-size: 10px;">{{ description }}</p>
              </div>
            </div>
          </div>
  ...
  new Vue({
    el: '#app',
     data: {
       portfolioItems: [
        {
            repositories: 'https://github.com/rcarmas?tab=repositories',
        ...
        {
            repositories: 'https://github.com/fscardenas1?tab=repositories',  
        ...
        {
            repositories: 'https://github.com/rafa-fz?tab=repositories',  
            name: 'Rafael Fonseca',
         ...
         {
            repositories: 'https://github.com/dilanzurita?tab=repositories',
            name: 'Dilan Zurita',
